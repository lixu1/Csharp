...
sqlStr="select * from news where newsid=" & clng(id)
Rs.open sqlStr,conn,1,1
if not Rs.eof then
%>
<form method="POST" name="myform" onSubmit="return CheckForm();" action="Admin_NewsSave.asp?action=Modify">
...
&nbsp;&nbsp;&nbsp;            </td>
          ...
          <tr class="tdbg">
            ...
            <td><input name="hidden" type="hidden" id=myText3 style="width:200px" onChange="doChange(this,defaultpic)">
              &nbsp;
              <input name="defaultpic" size=1 id=defaultpic style="width:350px" value="<%=rs("hotpic")%>"></td>
          </tr>
          <tr class="tdbg">
            <td align="right" valign="middle"><strong>点击次数：</strong></td>
            <td colspan="2"><input name="hits" type="text" id="hits" value="<%=rs("hits")%>" size="5"></td>
          </tr>
        </table>
      </td>
    </tr>
