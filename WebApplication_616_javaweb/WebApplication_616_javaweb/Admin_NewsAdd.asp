...
<body>
<form method="POST" name="myform" onSubmit="return CheckForm();" action="Admin_NewsSave.asp" target="_self">
  <table border="0" align="center" cellpadding="0" cellspacing="0" class="border">
	...
	<table width="100%" border="0" cellpadding="2" cellspacing="1">
          ...
          <tr class="tdbg"> 
            ...
            <td colspan="2"> <input name="Author" type="text" value="<%=session("AdminName")%>" size="50" maxlength="100">            </td>
          </tr>
          <tr class="tdbg"> 
          ...
          <tr class="tdbg">
            ...
            <td colspan="2">
			<input id=myText3 style="width:200px" onChange="doChange(this,defaultpic)" type="hidden">&nbsp;<select id=defaultpic name="defaultpic" size=1 style="width:350px"></select>			</td>
          </tr>
          <tr class="tdbg">
