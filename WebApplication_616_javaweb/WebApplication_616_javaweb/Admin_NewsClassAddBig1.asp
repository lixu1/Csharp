...
if Action="Add" then
	...
	if FoundErr<>True then
		...
		rs.open "Select * From QDClass Where ClassName='" & BigClassName & "'",conn,1,3
    ...
    <td align="center" valign="top"><table width="80%" border="0" cellpadding="0" cellspacing="0">
        <tr> 
          <td height="25" align="center" valign="top"> <br>
            ...
            <form name="form1" method="post" action="Admin_NewsClassAddBig1.asp" onsubmit="return checkBig()">
