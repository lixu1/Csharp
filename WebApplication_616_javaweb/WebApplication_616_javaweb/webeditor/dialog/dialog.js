...
function SelectBrowse(type, what){
	...
	var arr = showModalDialog('../browse.asp?type='+type, window, "dialogWidth:540px; dialogHeight:500px; help: no;scroll:no;status:no");
	if (arr){
		el.value = arr;
	}
}
...
function SelectFiles(objname,scid,stype){
  var arr=showModalDialog('../browse.asp?'  + 'folder='   + '', '', 'dialogWidth:538px; dialogHeight:500px; help: no; scroll: yes; status: yes');
	if(arr!=null){
