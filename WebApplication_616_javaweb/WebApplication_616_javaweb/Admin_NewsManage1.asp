...
if request("Action")="aa" then
	...
	rs.Update
	rs.Close
	Response.Redirect "Admin_NewsManage1.asp?page=" & request("page") & "&ClassID=" & request("ClassID")
end if
...
function ConfirmDel()
{
	...
	{
		document.myform.action="Admin_NewsDel1.asp";
...
<table width="100%" border="0" align="center" cellpadding="2" cellspacing="1" class="border">
  ...
  <tr class="tdbg"> 
    ...
    <td><a href="Admin_NewsManage1.asp">新闻管理首页</a>&nbsp;|&nbsp;<a href="Admin_NewsAdd1.asp">添加新闻</a></td>
  </tr>
</table>
<br>
<table width="100%" border="0" align="center" cellpadding="2" cellspacing="1" class="border">
  <tr class="title"> 
    ...
    response.write "|&nbsp;&nbsp;"
    do while not Rs.eof 
    	response.write "&nbsp;&nbsp<a href='Admin_NewsManage1.asp?ClassID="&Rs("ClassID")&"'>" & Rs("ClassName") & "</a>&nbsp;&nbsp;|"
    	Rs.movenext
    loop
    Rs.close
    %></td>
...
<table width='80%' border="0" cellpadding="0" cellspacing="0" align=center><tr>
    <form name="myform" method="Post" action="Admin_NewsDel11.asp" onSubmit="return ConfirmDel();">
     <td><table class="border" border="0" cellspacing="1" width="100%" cellpadding="0">
          <tr class="title" height="22"> 
            ...
            <td align="center"  width=291><strong>新闻标题</strong></td>
            <td width="372" align="center" ><strong>操作</strong></td>
          </tr>
          <%
          dim ClassID,page,i
          ClassID=request("ClassID")
          if ClassID="" then
		      sqlStr="select * from QDnews order by adddate desc, newsid desc"
          else
          	  sqlStr="select * from QDnews where ClassID=" & clng(ClassID) & " order by adddate desc, newsid desc"
          end if
          set Rs=server.createobject("adodb.recordset")
          ...
          <tr class="tdbg" onMouseOut="this.style.backgroundColor=''" onMouseOver="this.style.backgroundColor='#BFDFFF'"> 
            <td width="30" align="center"><input name='NewsID' type='checkbox' onClick="unselectall()" id="ArticleID" value='<%=Rs("newsid")%>'></td>
            <td width="25" align="center"><%=Rs("newsid")%></td>
            <td> <%=Rs("title")%></td>
            <td width="372" align="center"> <%
            	response.write "<a href='Admin_NewsModify1.asp?newsID=" & Rs("newsid") &"'>修改</a>&nbsp;&nbsp;"
            	response.write "<a href='Admin_NewsDel1.asp?newsID=" & Rs("newsid") & "&Action=Del' onclick='return ConfirmDel();'>删除</a>&nbsp;"
            %>
            <a href="Admin_NewsManage1.asp?Action=aa&newsid=<%=Rs("newsid")%>&page=<%=page%>&ClassID=<%=ClassID%>">排序</a>
            </td>
          </tr>
          <%
			  Rs.movenext
