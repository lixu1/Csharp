...
<table width="100%" border="0" align="center" cellpadding="2" cellspacing="1" class="border">
  ...
  <tr class="tdbg"> 
    ...
    <td height="30"><a href="admin_m.asp">管理员管理首页</a>&nbsp;|&nbsp;<a href="admin_m.asp?Action=Add">新增管理员</a></td>
  </tr>
</table>
<%
if Action="Add" then
...
<table width='80%' border="0" cellpadding="0" cellspacing="0" align=center>
  <tr>
  <form name="myform" method="Post" action="admin_m.asp" onSubmit="return confirm('确定要删除选中的管理员吗？');">
     <td>
<table width="100%" border="0" align="center" cellpadding="2" cellspacing="1" class="border">
  ...
  <tr align="center" class="tdbg" onMouseOut="this.style.backgroundColor=''" onMouseOver="this.style.backgroundColor='#BFDFFF'"> 
	...
	%></td>
    <td width="150"><%
	response.write "<a href='admin_m.asp?Action=ModifyPwd&ID=" & rs("ID") & "'>修改密码</a>&nbsp;&nbsp;"
	if iCount>1 and rs("UserName")<>session("AdminName") then
		response.write "<a href='admin_m.asp?Action=Del&ID=" & rs("ID") & "' onClick=""return confirm('确定要删除此管理员吗？');"">删除</a>"
	else
		response.write "&nbsp;&nbsp;&nbsp;&nbsp;"
	end if
	%> </td>
...
sub AddAdmin()
%>
<form method="post" action="admin_m.asp" name="form1" onSubmit="javascript:return CheckAdd();">
  <table width="70%" border="0" align="center" cellpadding="2" cellspacing="1" class="border" >
    ...
    <tr> 
      <td height="40" colspan="2" align="center" class="tdbg"><input name="Action" type="hidden" id="Action" value="SaveAdd"> 
        ...
        &nbsp; <input name="Cancel" type="button" id="Cancel" value=" 取 消 " onClick="window.location.href='admin_m.asp'" style="cursor:hand;"></td>
    </tr>
  </table>
</form>
<%
...
%>
<form method="post" action="admin_m.asp" name="form1" onSubmit="javascript:return CheckModify();">
  <table width="70%" border="0" align="center" cellpadding="2" cellspacing="1" class="border" >
    <tr class="title"> 
