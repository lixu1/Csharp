...
rs.Open "Select * from NewsClass where ClassID=" & CLng(BigClassID),conn,1,3
    ...
    <td align="center" valign="top"><table width="80%" border="0" cellpadding="0" cellspacing="0">
        <tr> 
          <td align="center" valign="top"><br>
            <strong>新 闻 类 别 设 置</strong> <br> <br> <form name="form1" method="post" action="Admin_NewsClassModifyBig.asp">
