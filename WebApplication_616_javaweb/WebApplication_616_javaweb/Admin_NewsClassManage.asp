...
rsBigClass.open "Select * From NewsClass",conn,1,1
%>
...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
  <tr> 
    <td align="center" valign="top"><table width="90" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr> 
          <td height="20" align="center" valign="top"><a href="Admin_NewsClassAddBig.asp"><strong><font color="#FF0000"><u><br />
...
%>
              <tr bgcolor="#F2F8FF" class="tdbg"> 
				...
				&nbsp;<a href="Admin_NewsClassModifyBig.asp?BigClassID=<%=rsBigClass("ClassID")%>">修改</a> 
                  | <a href="Admin_NewsClassDelBig.asp?BigClassName=<%=rsBigClass("ClassName")%>&BigClassID=<%=rsBigClass("ClassID")%>" onClick="return ConfirmDelBig();">删除</a></td>
              </tr>
              <%
			  rsBigClass.movenext
	loop
